...
│   └── processed/           # Processed dataset after cleaning and transformations
...
│   └── 2_Modeling.ipynb     # Modeling and evaluation notebook
└── report.md            # Final report summarizing findings and recommendations
